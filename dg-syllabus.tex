...
\subsubsection{Due}
\begin{itemize}
 \item Assignment: Read the assigned \emph{7 things you should know about open educational resources}.  Then write a response of at least 200 words and submit it via Moodle. 
