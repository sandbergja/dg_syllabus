...
\subsection{October 8: Advising and student support}
\subsubsection{Due}
\begin{itemize}
...
\subsection{October 29: interdisciplinary thinking, critical thinking, time management, the research process}
We will be meeting in BC225
\subsubsection{Due}
\begin{itemize}
 \item Assignment 1: Find an academic journal article or viewpoint from the \htmladdnormallink{Opposing Viewpoints page on the DREAM Act}{http://ic.galegroup.com.ezproxy.libweb.linnbenton.edu:2048/ic/ovic/PageFinderPortletPage/PageFinderPortletWindow?u=lbcc&disableHighlighting=false&p=OVIC&prodId=&action=1&activityType=SelectedSearch&javax.portlet.action=portalRedirectAction&showDisambiguation=true&catId=GALE\%7CHPZVWQ261035391}.  Use the criteria listed in \cite{evaluation} as you read, then fill out the Moodle worksheet about the document you selected.
...
\subsection{November 5: Financial literacy}
\subsubsection{Due}
\begin{itemize}
